    ...
    <div className=" w-full md:w-1/3 bg-white border-2 border-lightText md:border-none p-5 rounded-lg shadow-[rgba(0,_0,_0,_0.24)_0px_3px_8px]">
      <div>
        <p className=" text-lightText">
          Our experience at Heritage City Restaurant was short of
          extraordinary. Every dish on the menu was a masterpiece, showcasing a
          perfect blend of tradition and innovation Exceptional Dining:
        </p>
      </div>  
